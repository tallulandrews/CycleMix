...
output1 <- classifyCells(all_data_joined, HGeneSets$Tirosh, expr_name="RNA")
# Using SCT normalized samples:
output2 <- classifyCells(all_data_sct, HGeneSets$Tirosh, expr_name="SCT")
```
...
```{r}
corrected_mat <- GetAssayData(all_data_sct, assay="SCT", layer="scale.data")
output3 <- classifyCells(corrected_mat, HGeneSets$Tirosh)
```
